...
describe('B group 111 question content', () => {
  const sourceIndex = getBGroupSourceIndex('111');

  it('contains one analysis for every indexed 111 source question', () => {
    ...
    expect(questions.every((question) => question.year === '111')).toBe(true);
  });
  ...
  it('keeps high-risk table and SSDLC content under review', () => {
