...
const CONFIRMED_RISKY_EXTRACTION_QUESTIONS: readonly number[] = [41, 42];
...
export function getAGroup113SystematicNoviceTeachingFailures(
...
export function getAGroup113ContentReviewChecklist(
  questions: readonly ExamQuestionAnalysis[]
): ContentReviewCheck[] {
  return getAGroupContentReviewChecklist(questions, CONTENT_REVIEW_CONFIG);
}

export function validateAGroup113QuestionContent(
  questions: readonly ExamQuestionAnalysis[]
